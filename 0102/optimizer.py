...
class SteepestAscent(HillClimbing):
    ...
    def run(self, p):
        ...
        while True:
            neightbors = p.mutants(current)
            successor, valueS = self.bestOf(neightbors,p)
            if valueS >= valueC:
                break
            else: 
                current = successor
...
class GradientDescent(HillClimbing):
    def displaySetting(self):  
        print()
        print("Search Algorithm: GradientDescent")
        print()
        print("Update rate:", self._alpha)
        print("Increment for calculating deriva")
